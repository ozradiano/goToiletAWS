...
//			kids = dbManager.getInstance().getListOfKids("1"); //׳�׳™׳›׳� ׳™׳¨׳•׳§׳”
...
//			System.out.println("should be 0: " + events.size());
//			
			dbManager.getInstance().insertNewEvent(new EventData("2014-11-22 13:31:00", "1", "1", new ArrayList<IndependenceStages>(), true, "test1", true, false, "0"));
			dbManager.getInstance().insertNewEvent(new EventData("2014-11-22 13:31:00", "1", "1", new ArrayList<IndependenceStages>(), true, "test2", false, true, "0"));
